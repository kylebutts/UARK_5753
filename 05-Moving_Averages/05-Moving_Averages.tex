...
\title{Time Series Smoothing Methods}
...
\imageframe{figures/candy_production.pdf}
...
\begin{frame}{Simple Exponential Smoothing and Recursion}
  ...
  \begin{align*}
    \ell_{t} 
    &= \alpha y_t + \alpha (1 - \alpha) y_{t-1} + (1 - \alpha)^2 \ell_{t-2}  \\
    &= \alpha y_t + \alpha (1 - \alpha) y_{t-1} + \alpha (1 - \alpha)^2  y_{t-2} + (1- \alpha)^3 \ell_{t-3}  \\
    &= \alpha y_t + \alpha (1 - \alpha) y_{t-1} + \alpha (1 - \alpha)^2  y_{t-2} + \alpha (1- \alpha)^3 y_{t-3} + (1 - \alpha)^4 \ell_{t-4}  \\
  \end{align*}
...
\imageframe{figures/candy_production.pdf}
\imageframe{figures/candy_forecast_ses.pdf}
\imageframe{figures/candy_forecast_holt.pdf}
\imageframe{figures/candy_forecast_holt_winters.pdf}
