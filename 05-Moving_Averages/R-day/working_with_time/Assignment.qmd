...
format: pdf
---
In preperation for the remainder of the course, we will be thinking about working with data that is arranged in time. 
...
today - ymd("1970-01-01") 

as.numeric(ymd("1970-01-01"))
as.numeric(ymd("1970-01-03"))
```
