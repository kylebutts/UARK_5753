...
%   \begin{align*}
%     \log(Y_1) - \log(Y_0) &= 
%     \left( \beta_0 + \beta_1 \log(X_0) \right) - \left(\beta_0 + \beta_1 \log(X_0 + 1)\right) \\[1em]
%     \implies \log(Y_1 / Y_0) &= \beta_1 \left( \log(\frac{X_0}{X_0 + 1}) \right) \\[1em]
%     \implies \log(1 + \frac{Y_1 - Y_0}{Y_0}) &= \beta_1 \left( \log(\frac{X_0}{X_0 + 1} - \frac{X_0 + 1}{X_0 + 1} + 1) \right) \\[1em]
%     \implies \log(1 + \frac{Y_1 - Y_0}{Y_0}) &= \beta_1 \left( \log(1 \frac{X_0}{X_0 + 1} - \frac{X_0 + 1}{X_0 + 1} + 1) \right) \\[1em]
%   \end{align*}
% \end{frame}
% 
