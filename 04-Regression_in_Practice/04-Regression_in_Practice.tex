...
\begin{frame}{Summary of log-transformed linear equations}
  \begin{table}
    ...
    @{}}
      ...
      $y = \beta_0 + \beta_1 x$ & 
      A 1 unit increase in $x$ increases $y$ by $\beta_1$ units \\[\medskipamount]

      $\log(y) = \beta_0 + \beta_1 x$ & 
      A 1 unit increase in $x$ increases $y$ by $\beta_1 * 100$ percent \\[\medskipamount]

      $y = \beta_0 + \beta_1 \log(x)$ & 
      A 1 percent increase in $x$ increases $y$ by $\beta_1$ units \\[\medskipamount]
