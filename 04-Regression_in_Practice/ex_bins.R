...
predictions$y_hat_bspline_p_1_s_0 <- predict(
  est_bspline_p_1_s_0,
  newdata = predictions
)
...
predictions$y_hat_bspline_p_1_s_1 <- predict(
  est_bspline_p_1_s_1,
  newdata = predictions
)
...
predictions$y_hat_bspline_p_2_s_2 <- predict(
  est_bspline_p_2_s_2,
  newdata = predictions
)
...
predictions$y_hat_bspline_few_knots <- predict(
  est_bspline_few_knots,
  newdata = predictions
)
