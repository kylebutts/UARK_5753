...
```{r}
## https://pageviews.wmcloud.org/?project=en.wikipedia.org&platform=all-access&agent=user&redirects=0&start=2024-07-01&end=2026-04-12&pages=Severance_(TV_series)
df <- read_csv("data/severance_wikipedia_views.csv") |>
  setNames(c("date", "views"))

# Filter since December 2024
df <- df |>
  filter(date >= ymd("2024-12-01") & date <= ymd("2025-09-30"))
